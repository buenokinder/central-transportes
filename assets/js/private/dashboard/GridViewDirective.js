    ...
    app.directive('gridView', [ '$compile', function ($compile) {
        return {
            ...
            scope: {
                ...
                HtmlFormBody += "<div class='container' ng-init='init()'><div class='row'><div class='col-md-4'>&nbsp;</div></div><div class='row'   ng-                                            show='exibir(strupdate)'><div class='col-md-4'><a href='{{adicionar}}' ng-show='exibirAdd()' class='btn btn-labeled btn-primary'>Adicionar Novo</a></div>                                        </div><div class='row'><div class='col-md-4'>&nbsp;</div></div>";
                ...
                HtmlFormBody += "<button type='button' class='btn btn-default btn-sm' ng-click='deletedata(datum.id)' aria-label='Left Align'><i class='fa fa-trash-o' aria-hidden='true'></i></button></td></tr></tbody>";
